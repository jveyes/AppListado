"""
Django settings for RematesNacionales project.
...
SECRET_KEY = 'django-insecure-=fmlq+u*w0#u115iyj^1o)2z&+*^ur*la6^*+lshk)i*o-52@9'
...
WSGI_APPLICATION = 'RematesNacionales.wsgi.application'
